...
def process_and_plot(folder_path):
    ...
    for root, dirs, files in os.walk(folder_path):
        for dir_name in dirs:
            match = re.match(r'^two_nodes_(m2)-(\d+\.\d+)KB-(11)$', dir_name)
            if match:
    ...
    plt.savefig("/home/lucian/simple-chain-ws/src/ros2-latency-analysis/analysis/results/two-nodes/two_nodes_box_m2-11.png")
    plt.show()
